...
if uploaded_file is not None:
    ...
    for page_num in range(total_pages):
        ...
        for widget in page.widgets():
            ...
            # Strict height clipping keeps rows from bleeding down onto adjacent form text labels
            if height_pct > 2.8:
                height_pct = 2.2
            elif height_pct < 1.5:
                height_pct = 1.7
            ...
            # True checkbox squares have an aspect ratio close to 1. Numeric/text input entries are wider rectangles.
    ...
    # --- STANDARD TRIPLE DOUBLE STRING (SAFE FROM ALL BRACKET & LITERAL ERRORS) ---
    raw_template = """
